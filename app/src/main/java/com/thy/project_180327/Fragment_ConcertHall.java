...
public class Fragment_ConcertHall extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_concerthall, container, false);
                ...
                while(eventType != XmlPullParser.END_DOCUMENT && isRun){
                    ...
                    switch(eventType){
                        ...
                        case XmlPullParser.END_TAG:
                            ...
                            if(tagName.equals("row")){
                                if(item.getCodeName() != null && item.getCodeName().toString().equals("공연장")) {
                                    items.add(item);
                                }
