...
public class Fragment_All extends Fragment implements SurfaceHolder.Callback {
                ...
                while(eventType != XmlPullParser.END_DOCUMENT && isRun){
                    ...
                    switch(eventType){
                        ...
                        case XmlPullParser.START_TAG:
                            ...
                            }else if(tagName.equals("X_COORD")){
                                xpp.next();
                                if(item != null) item.setXcoord(xpp.getText());

                            }else if(tagName.equals("Y_COORD")){
                                xpp.next();
                                if(item != null) item.setYcoord(xpp.getText());
