...
public class Fragment_ArtGallery extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.layout_artgallery, container, false);
    ...
    void XMLParsing(){
        try {
            ...
            URL url = new URL("http://openapi.seoul.go.kr:8088/"+apiKey+"/xml/SearchCulturalFacilitiesDetailService/1/1000/");

            //별도 스레드객체 생성
            //스레드의 백그라운드 작업과 UI작업을 같이 할 수 있는 객체를 생성
            XMLParserTask task = new XMLParserTask();
                ...
                while(eventType != XmlPullParser.END_DOCUMENT  && isRun){
                    ...
                    switch(eventType){
                        ...
                        case XmlPullParser.END_TAG:
                            ...
                            if(tagName.equals("row")){
                                if(item.getCodeName() != null && item.getCodeName().toString().equals("미술관")) {
                                    items.add(item);
                                }
